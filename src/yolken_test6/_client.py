...
from ._exceptions import APIStatusError, YolkenTest6Error
...
class YolkenTest6(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous YolkenTest6 client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("YOLKEN_TEST6_BASE_URL")
        if base_url is None:
            base_url = f"https://petstore3.swagger.io/api/v3"

        custom_headers_env = os.environ.get("YOLKEN_TEST6_CUSTOM_HEADERS")
    ...
    @cached_property
    def with_raw_response(self) -> YolkenTest6WithRawResponse:
        return YolkenTest6WithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> YolkenTest6WithStreamedResponse:
        return YolkenTest6WithStreamedResponse(self)
...
class AsyncYolkenTest6(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncYolkenTest6 client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncYolkenTest6WithRawResponse:
        return AsyncYolkenTest6WithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncYolkenTest6WithStreamedResponse:
        return AsyncYolkenTest6WithStreamedResponse(self)
...
class YolkenTest6WithRawResponse:
    _client: YolkenTest6

    def __init__(self, client: YolkenTest6) -> None:
        self._client = client
...
class AsyncYolkenTest6WithRawResponse:
    _client: AsyncYolkenTest6

    def __init__(self, client: AsyncYolkenTest6) -> None:
        self._client = client
...
class YolkenTest6WithStreamedResponse:
    _client: YolkenTest6
...
class AsyncYolkenTest6WithStreamedResponse:
    _client: AsyncYolkenTest6
