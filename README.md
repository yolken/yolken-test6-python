...
pip install git+ssh://git@github.com/stainless-sdks/yolken-test6-python.git
```
...
```sh
# install from this staging repo
pip install 'yolken_test6[aiohttp] @ git+ssh://git@github.com/stainless-sdks/yolken-test6-python.git'
```
...
These methods return an [`APIResponse`](https://github.com/stainless-sdks/yolken-test6-python/tree/main/src/yolken_test6/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/yolken-test6-python/tree/main/src/yolken_test6/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/yolken-test6-python/issues) with questions, bugs, or suggestions.
